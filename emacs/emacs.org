...
*** Packages
    :PROPERTIES:
    :ID:       9A30ED8D-3ECA-4502-A479-B1EE717FF5E9
    :END:
...
*** Keybindings
    :PROPERTIES:
    :ID:       0EC420B9-8484-4260-A799-8AB59834430B
    :END:
    #+begin_src emacs-lisp :results none
    (use-package general
        :config
...
**** Vim
     :PROPERTIES:
     :ID:       EC237C5C-7B84-4A23-8DA5-2205A48C07B1
     :END:
     #+begin_src emacs-lisp :results none
       ;; Vim keybindings
       (use-package evil
...
**** Keybindings
     :PROPERTIES:
     :ID:       C6863F6B-F715-43F2-BD5C-55A2770F61E9
     :END:
     #+begin_src emacs-lisp :results none
...
**** UI
     :PROPERTIES:
     :ID:       117371D1-DED6-41C4-938E-2E3985AC407A
     :END:
     #+begin_src emacs-lisp :results none
...
**** Style
     :PROPERTIES:
     :ID:       D0FF8DCF-8D4F-423C-A3AA-9C97C45657F3
     :END:
     #+begin_src emacs-lisp :results none
       ;; Theme
...
** Autocomplete
   :PROPERTIES:
   :ID:       CA40FCBA-70F5-42AA-B73A-CA36C9CD52DA
   :END:
...
** Editor 
   :PROPERTIES:
   :ID:       96405D7A-836D-4724-A465-9B0CA6893305
   :END:
...
*** Org Mode
    :PROPERTIES:
    :ID:       80F98E85-2239-425A-8631-40808D0D8830
    :END:
...
**** Movement
     :PROPERTIES:
     :ID:       35FB9957-2A45-42AD-B6B6-106B8340ECC1
     :END:
    #+begin_src emacs-lisp :results none
...
**** Editing
     :PROPERTIES:
     :ID:       3C4AA5CA-0BAB-44B2-AC10-6E535557771A
     :END:
    #+begin_src emacs-lisp :results none
...
**** Todo
     :PROPERTIES:
     :ID:       DF992C91-0DC4-4A73-B2E6-D94C5E554802
     :END:
     #+begin_src emacs-lisp :results none
...
**** Agenda
     :PROPERTIES:
     :ID:       4FD603F4-7305-45A9-9BB1-EA39CF70735A
     :END:
     #+begin_src emacs-lisp :results none
       (evil-set-initial-state 'org-agenda-mode 'normal)

       (setq org-agenda-files '("~/todo/next-actions.org"
                                "~/todo/projects.org"
                                "~/todo/waiting.org"
                                "~/todo/scheduled.org"))
...
**** Capture
     :PROPERTIES:
     :ID:       87822AB9-D6D1-423E-9992-703CA35D471F
     :END:
    #+begin_src emacs-lisp :results none
      ...
      (setq org-refile-targets
            '((gn/inbox-path :level . 1)
              ("~/todo/next-actions.org" :level . 1)
              ("~/todo/projects.org" :level . 1)
              ("~/todo/waiting.org" :level . 1)
              ("~/todo/scheduled.org" :level . 1)
...
**** Source Mode
     :PROPERTIES:
     :ID:       E8439491-DD2C-414E-893E-81CA9B76B7C8
     :END:
    #+begin_src emacs-lisp :results none
...
**** Template
     :PROPERTIES:
     :ID:       0D37799C-854A-4429-A963-11B39F6D3EAF
     :END:
     #+begin_src emacs-lisp :results none
       (defvar gn/org-template-path "~/config/emacs/templates.org")
...
**** Getting Things Done
     :PROPERTIES:
     :ID:       8BCAEE75-6EFC-4702-A2F9-20ADC62E9CBB
     :END:
     #+begin_src emacs-lisp :results none
     #+end_src
...
**** Keybindings
     :PROPERTIES:
     :ID:       0E09937D-DA0C-4617-B561-5A2521D0AA09
     :END:
     #+begin_src emacs-lisp :results none
...
*** Magit
    :PROPERTIES:
    :ID:       26383A59-ADC7-4DBD-8BE3-934AB23621FA
    :END:
    #+begin_src emacs-lisp :results none
      (use-package magit
        :config
