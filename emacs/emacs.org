...
*** Org Mode
    ...
    #+begin_src emacs-lisp :results none
      ...
      (defun gn/test-at-item ()
        ""
        (interactive)
        (message (if (org-at-item-p)
                    "true" "false")))
      ...
      (defun gn/org-insert-new-item ()
        ...
        (interactive)
        (evil-append-line 0)
        (cond ((org-at-item-checkbox-p) ((evil-end-of-line))
              ((org-in-item-p) (org-insert-item))
              ()
          )))

      (gn/org-insert-new-item)
